...
train_dir = 'C:\\Emotion-detection\\src\\train'
val_dir = 'C:\\Emotion-detection\\src\\test'
...
if mode == "train":
    ...
    model.save_weights('C:\Emotion-detection\model.h5')

# Displaying emotions from webcam feed
elif mode == "display":
    model.load_weights('C:\Emotion-detection\model.h5')
